//
//  CastSelectViewController.swift
//  swift_skyway
//
...
class CastSelectViewController: UIViewController,UIScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,IndicatorInfoProvider {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if(self.appDelegate.castMoviePlayerNumSubMenu00 == 1){
            self.player00.play()
        }else if(self.appDelegate.castMoviePlayerNumSubMenu00 == 2){
            self.player01.play()
        }else if(self.appDelegate.castMoviePlayerNumSubMenu00 == 3){
            self.player02.play()
        }
        //初期状態に戻す
        ...
        dispatchGroup.notify(queue: .main) {
            ...
            if(self.castListTemp.count > 0){
                ...
                if(self.castList[0].movie_flg == "1"){
                    //動画の場合
                    self.appDelegate.castMoviePlayerNumSubMenu00 = 1
                }
                ...
                HTTPDiagnostics.shared.dataTask(with: req, dedupKey: dedupKey) { (data, res, err) in
                    ...
                    do{
                        ...
                        for obj in json.result {
                            ...
                            self.strSelectConnectLevel = obj.connect_level
                            self.strSelectConnectExp = obj.connect_exp
                            self.strSelectConnectLiveCount = obj.connect_live_count
                            self.strSelectConnectPresentPoint = obj.connect_present_point
