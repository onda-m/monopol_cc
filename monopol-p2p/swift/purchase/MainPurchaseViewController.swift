//
//  MainPurchaseViewController.swift
//  swift_skyway
//
...
class MainPurchaseViewController: ButtonBarPagerTabStripViewController, UITabBarDelegate{
    ...
    override func viewDidLoad() {
        ...
        //ボタンを生成(マイページ)
        let myPageBtn:UITabBarItem = UITabBarItem(title: nil, image: UIImage(named:mypageOnBtnName), tag: 5)
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let firstVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toPurchaseViewController")
        let secondVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toPurchaseRirekiViewController")
        //let thirdVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toUsedRirekiViewController")
