//
//  ListenerListViewController.swift
//  swift_skyway
//
...
class ListenerListViewController: UIViewController, IndicatorInfoProvider,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    //ここがボタンのタイトルに利用されます
    var itemInfo: IndicatorInfo = "登録順"
    ...
    func getListenerListByCast(){
        ...
        stringUrl.append("?order=1&cast_id=")
