//
//  MainListenerViewController.swift
//  swift_skyway
//
...
class MainListenerViewController: ButtonBarPagerTabStripViewController, UITabBarDelegate{
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let firstVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "toListenerListViewController")
        let secondVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "toListenerListByConnectionLevelViewController")
