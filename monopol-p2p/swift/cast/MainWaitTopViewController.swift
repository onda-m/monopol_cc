...
class MainWaitTopViewController: ButtonBarPagerTabStripViewController, UITabBarDelegate{
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let firstVC = UIStoryboard(name: "Wait", bundle: nil).instantiateViewController(withIdentifier: "toWaitTopViewController")
        let secondVC = UIStoryboard(name: "Wait", bundle: nil).instantiateViewController(withIdentifier: "toEventTopViewController")
