...
class MainReportViewController: ButtonBarPagerTabStripViewController, UITabBarDelegate{
    ...
    override func viewControllers(for pagerTabStripController: PagerTabStripViewController) -> [UIViewController] {
        ...
        let firstVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toLiveReportViewController")
        let secondVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toLiveRirekiViewController")
        let thirdVC = UIStoryboard(name: "Mypage", bundle: nil).instantiateViewController(withIdentifier: "toRequestRirekiViewController")
